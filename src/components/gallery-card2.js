    ...
    <div className={`gallery-card2-gallery-card ${props.rootClassName} `}>
      <div className="gallery-card2-container">
        <div className="gallery-card2-container1">
          <h2 className="gallery-card2-heading">{props.title}</h2>
          <span className="gallery-card2-text">{props.description}</span>
          <span className="gallery-card2-text1">SHOW MORE</span>
        </div>
      </div>
      <img
        alt={props.image_alt}
